...
//      Comparison Operators [ ==,!=,<,>,<=,>= ]
        ...
        System.out.println(" is 2658 not equal to 1256 ? " + (2658!=1256));    // here,!= represent not equal to
        System.out.println(" is 158 not equal to 158 ? " + (158!=158));
        System.out.println(" is 50 greater than equal to 125 ? " + (50>=125));
        System.out.println(" is -12 less than equal to -8 ? " + (-12 <= -8));
